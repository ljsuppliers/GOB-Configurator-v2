...
import { buildPremiumBom, USE_TAGS } from './bom/premium-bom.js?v=14';
import { loadCatalogue, saveCatalogue, joinBom, buildOrders, catalogueEmptyMaterial, SUPPLY_MODES } from './bom/orders.js?v=9';
