...
import { buildPremiumBom, USE_TAGS } from './bom/premium-bom.js?v=27';
import { loadCatalogue, saveCatalogue, joinBom, buildOrders, catalogueEmptyMaterial, SUPPLY_MODES } from './bom/orders.js?v=23';
